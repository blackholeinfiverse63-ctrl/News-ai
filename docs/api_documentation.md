...
**Validation Schemas:**
- `tone`: Must be one of: "neutral", "positive", "negative", "formal", "casual"
- `language`: Must be a 2-letter ISO language code (e.g., "en", "es", "fr")
- `avatar_ready`: Boolean flag indicating if avatar is ready for use
